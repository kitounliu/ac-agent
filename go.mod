module github.com/kitounliu/ac-agent
...
require (
	...
	github.com/fetchai/fetchd v0.11.0-rc2.0.20220810093106-be5f56c7855b
...
replace (
	...
	github.com/fetchai/fetchd => github.com/kitounliu/fetchd v0.8.3-0.20220825150744-14cfdab192f5
